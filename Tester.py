...
class Tester(Simulation):
    ...
    def getTestSimRunner(self):
        return DriverTest(self.cmd, self.setUpTuple, *self.getMaxSimulationTimes(), *self.getUserDefinedRules(), self.useShoutahead, self.useEVCoopPredicates, self.rulesetOptions)
