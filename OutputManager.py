...
def run(agentPools, avgGenTime, totalGenTime):
    ...
    for ap in agentPools:
        ...
        f.write("The top individual has a fitness of" + str(topIndividual.getFitness()) +
                "and its RS and RSint sets contain the following rules (formatted as \"<conditions>, <action>\"):\n\n RS:\n")
        ...
        for rule in topIndividual.getRS():
            ...
            f.write("RS Rule" + str(ruleCount) + ": <" + cond + ">, <" + str(rule.getAction()
                                                                             ) + "> and rule has a weight of" + str(rule.getWeight()) + "\n\n")
            ruleCount += 1
        ...
        for rule in topIndividual.getRSint():
            ...
            f.write("RSint Rule" + str(ruleCount) + ": <" + cond + ">, <" + str(
                rule.getAction()) + "> and rule has a weight of" + str(rule.getWeight()) + "\n\n")
            ruleCount += 1
